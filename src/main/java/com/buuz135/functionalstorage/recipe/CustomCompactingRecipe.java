...
public class CustomCompactingRecipe extends SerializableRecipe {
    public static GenericSerializer<CustomCompactingRecipe> SERIALIZER = new GenericSerializer<>(new ResourceLocation(FunctionalStorage.MOD_ID, "custom_compacting"), CustomCompactingRecipe.class);
